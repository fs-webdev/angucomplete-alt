...
This is a fork of Hidenari Nozaki's angucomplete-alt (https://github.com/ghiden/angucomplete-alt) but with a custom ngModel attribute.

### New Feature
* Pass in your own object to the input's ngModel.

To view a majority of the documentation, go to [ghiden's angucomplete-alt repo](https://github.com/ghiden/angucomplete-alt)
